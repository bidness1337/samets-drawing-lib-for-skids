--[[
    originally made by samet but got slightly modified by yukaii lads
...
Tween:Create(Gui, TweenInfo.new(0.17, Enum.EasingStyle.Quart, Enum.EasingDirection.Out), {Size = Delta}, true)
    ...
    local CustomFont = { } do
        ...
        CustomFont:New("VerdanaBold", 700, "Bold", {
            Url = "https://raw.githubusercontent.com/suspendthread/uwu/refs/heads/main/dependencies/assets/fonts/VerdanaBold.txt"
        })
        Library.Font = CustomFont:Get("VerdanaBold")
    end
    ...
    Library.Watermark = function(self, Name)
        ...
        local Items = { } do
            ...
            Instances:Create("UIGradient", {
                ...
                Rotation = 0,
                Color = RGBSequence{RGBSequenceKeypoint(0, Library.Theme.Accent), RGBSequenceKeypoint(1, FromRGB(0, 0, 0))}
            })
        end
    ...
    Library.Notification = function(self, Text, Duration, Color, Icon)
        local Items = { } do
            ...
            Instances:Create("UIGradient", {
                Parent = Items["AccentLine"].Instance,
                Rotation = 0,
                Color = RGBSequence{RGBSequenceKeypoint(0, Color), RGBSequenceKeypoint(1, FromRGB(0, 0, 0))}
            })
    ...
    Library.Window = function(self, Data)
        ...
        local Items = { } do
            ...
            Items["Content"] = Instances:Create("Frame", {
                Parent = Items["MainFrame"].Instance,
                Name = "\0",
                Position = UDim2New(0, 134, 0, 27),
                BorderColor3 = FromRGB(10, 10, 10),
                Size = UDim2New(1, -155, 1, -41),
                BorderSizePixel = 2,
                BackgroundColor3 = FromRGB(15, 15, 20)
    ...
    Library.Page = function(self, Data)
        ...
        local Items = { } do
            ...
            -- Removed Items["Hide"] to eliminate the unwanted accent line on page tabs
            Instances:Create("UIGradient", {
                Parent = Items["Inactive"].Instance,
                Rotation = 0,
        ...
        function Page:Turn(Bool)
            ...
            if Bool then
                ...
                -- Removed Items["Hide"].Instance.Visible = true
                ...
                -- Removed Items["Hide"].Instance.Visible = false
                Items["Inactive"].Instance.BackgroundTransparency = 1
                local stroke = Items["Inactive"].Instance:FindFirstChildOfClass("UIStroke")
                if stroke then
                    stroke.Transparency = 1

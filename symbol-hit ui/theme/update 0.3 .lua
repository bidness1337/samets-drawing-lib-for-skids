...
[[ from GitHub. Make sure the file exists in the assets folder or on GitHub.]])
    ...
    do
        ...
        function Library.ColorpickerWindow(self)
            ...
            do
                -- MODIFIED: Made colorpicker wider (rectangle instead of square)
                Objects.Outline = Utility.New('Frame', {
                    Name = 'Outline',
                    Size = UDim2.new(0, 200, 0, 150),  -- Changed to 200x150 (wider)
                    BorderSizePixel = 0,
                ...
                -- MODIFIED: Slightly wider hue picker
                Objects.HueOutline = Utility.New('TextButton', {
                    Name = 'HueOutline',
                    Size = UDim2.new(0, 16, 1, 0),  -- Slightly wider
...
-cfg.size.Y.Offset / 2),
        ...
        -- MODIFIED: Tab function with selection line instead of outline
        ...
        -- MODIFIED: Toggle function with toggle on the LEFT side
        function Library.Toggle(self, cfg)
            ...
            do
                ...
                -- Main row container (horizontal layout for toggle + text)
                ...
                -- Toggle outline (now on the LEFT)
                Objects.Outline = Utility.New('Frame', {
                    Name = 'Outline',
                    Size = UDim2.new(0, 0, 0, 0),
                    Position = UDim2.fromOffset(0, 0),
                ...
                -- Text label (now on the RIGHT of the toggle)
                Objects.Text = Utility.New('TextLabel', {
                    Name = 'Text',
                    TextStrokeTransparency = 0.8,
                    BackgroundTransparency = 1,
